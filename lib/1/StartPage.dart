  ...
  Widget build(BuildContext context) {
    Widget page = pageNumber == 1
        ? Page(
            ...
            question: 'هل تسافر عادة للعمل أو لأسباب شخصية أو لأي سبب آخر؟',
            answers: <String>["طباعة", "خدمة تعليمية", "مزاد الكتب"],
            number: 1,
          )
        : Page(
            key: Key('page2'),
            onOptionSelected: () => setState(() => pageNumber = 1),
            question: 'كم ساعة هو متوسط رحلتك؟',
            answers: <String>[
              "أقل من ساعتين",
              "أكثر من ساعتين ولكن أقل من خمس ساعات",
              'الآخرين'
            ],
            number: 2,
          );
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: visible ? Colors.white : Colors.red,
      ),
    );
  }
}
