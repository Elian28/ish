                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        model.description +
                                            "To switch to a new route, use the Navigator. To switch to a new route, use the Navigator.push() method. The push() method adds a Route to the stack of routes managed by the Navigator.",
                                        textAlign: TextAlign.justify,
                                        style: TextStyle(
                                          fontSize: 12,
                                          color: Colors.grey,
