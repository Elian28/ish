...
class CarFreshenerCard extends StatefulWidget {
  @override
  _CarFreshenerCardState createState() => _CarFreshenerCardState();
}

class _CarFreshenerCardState extends State<CarFreshenerCard> {
  //!
