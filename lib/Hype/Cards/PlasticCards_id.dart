...
//1 بطاقات بلاستيك id
class PlasticCards_id extends StatefulWidget {
  @override
  _PlasticCards_idState createState() => _PlasticCards_idState();
}

class _PlasticCards_idState extends State<PlasticCards_id> {
  //!
