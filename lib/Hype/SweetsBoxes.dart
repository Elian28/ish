...
//!طباعة علب الحلويات الفاخرة
class SweetsBoxes extends StatefulWidget {
  @override
  _SweetsBoxesState createState() => _SweetsBoxesState();
}

class _SweetsBoxesState extends State<SweetsBoxes> {
  ...
  String name = 'طباعة علب الحلويات الفاخرة';
//!
  String radioItemHolder = 'وزن نصف كيلو';
    ...
    return Container(
        ...
        child: Scaffold(
            body: Column(
              ...
              RaisedButton(child: Text("ارسال للسلة"), onPressed: _saveData)
            ])));
  }
