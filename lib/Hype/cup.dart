...
//!
  String radioItemHolder = 'قياس 22x9';
  String radioItemHolderColor = 'وجهين';

  // Group Value for Radio Button.
  int id = 1;
  int idColor = 1;
  String name = "طباعة فنجال او اكواب";
    ...
    return Container(
        ...
        child: Scaffold(
            body: Column(
              ...
              Container(
                  height: AppTheme.fullHeight(context) / 11,
                  child: Column(
                      children: nList
                          .map((data) => Flexible(
                              fit: FlexFit.tight,
