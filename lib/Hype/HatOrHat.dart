...
// قبعة وطاقية
class HatOrHat extends StatefulWidget {
  @override
  _HatOrHatState createState() => _HatOrHatState();
}

class _HatOrHatState extends State<HatOrHat> {
...
//!
  ...
  int id = 1;
  int idColor = 1;
  List<NumberList> colorList = [
    NumberList(
      index: 0,
      number: "تظريز لون واحد",
    ),
    NumberList(
      index: 1,
      number: "ملون",
