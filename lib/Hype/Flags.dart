...
//!
  String radioItemHolder = 'مفرد';

  // Group Value for Radio Button.
  int id = 1;
  String name = "اعلام الطاولة مع قاعدة حديد";
  List<NumberList> nList = [
    NumberList(index: 1, number: "مفرد"),
    NumberList(index: 2, number: "ثنائي"),
    NumberList(index: 3, number: "ثلاثي")
  ];
  int numOfItems = 1;
