...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Map<String, dynamic>> categories = [
    ...
    {"icon": "assets/icon/Untitled-3@60x60x1.png", "text": "مفتوح"},
    {"icon": "assets/icon/Untitled-3@60x60x1.png", "text": "أكثر"}
  ];
  ...
  appbar(BuildContext context) {
    return Padding(
        ...
        child:
          ...
          serachWid(context),
          cartAppBar(
              svgSrc: "assets/icon/Untitled-3@60x60x1.png",
              press: () {
  ...
  Widget sectonTitle({String title, GestureTapCallback press, bool tru}) {
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      ...
      GestureDetector(
          onTap: press,
          child:
              Text("مشاهدة الكل", style: TextStyle(color: Color(0xFFBBBBBB))))
    ]);
  }
