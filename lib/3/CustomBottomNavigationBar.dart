...
import 'BackgroundCurvePainter.dart';

//TODO TapBBar
class CustomBottomNavigationBar extends StatefulWidget {
  final Function(int) onIconPresedCallback;
  CustomBottomNavigationBar({this.onIconPresedCallback});
...
class _CustomBottomNavigationBarState extends State<CustomBottomNavigationBar>
        ...
        child: AnimatedContainer(
          ...
          child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                  color: isEnable ? LightColor.iconColor : Colors.white,
                  boxShadow: <BoxShadow>[
                    BoxShadow(
  ...
  Widget build(BuildContext context) {
    ...
    final height = appSize.height / 12;
    return Container(
      width: appSize.width,
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                _icon(Icons.shopping_cart, _selectedIndex == 0, 0),
              ],
            ),
          ),
        ],
