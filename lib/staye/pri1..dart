...
class Pri1 extends StatefulWidget {
  @override
  _Pri1State createState() => _Pri1State();
}
        ...
        Row(
          ...
          children: <Widget>[
            UnicornOutlineButton(
              ...
              child: Text('بنر ', style: TextStyle(fontSize: 16)),
              onPressed: () {
            ...
            UnicornOutlineButton(
              ...
              gradient:
                  LinearGradient(colors: [Colors.black, Colors.redAccent]),
              child: Text('إستكر', style: TextStyle(fontSize: 16)),
              onPressed: () {},
            ),
            SizedBox(width: 18, height: MediaQuery.of(context).size.height / 55),
            UnicornOutlineButton(
              ...
              gradient:
                  LinearGradient(colors: [Colors.black, Colors.redAccent]),
              child: Text('فليكس', style: TextStyle(fontSize: 16)),
              onPressed: () {},
            ),
            SizedBox(width: 18, height: MediaQuery.of(context).size.height / 55),
          ],
        ...
        Row(
          ...
          children: <Widget>[
            UnicornOutlineButton(
              ...
              gradient:
                  LinearGradient(colors: [Colors.black, Colors.redAccent]),
              child: Text('رول أب', style: TextStyle(fontSize: 16)),
              onPressed: () {},
            ),
            SizedBox(width: 18, height: MediaQuery.of(context).size.height / 55),
            UnicornOutlineButton(
              ...
              gradient:
                  LinearGradient(colors: [Colors.black, Colors.redAccent]),
              child: Text('اكس ', style: TextStyle(fontSize: 16)),
              onPressed: () {},
            ),
            SizedBox(width: 18, height: MediaQuery.of(context).size.height / 55),
            UnicornOutlineButton(
              ...
              gradient:
                  LinearGradient(colors: [Colors.black, Colors.redAccent]),
              child: Text('طاولات', style: TextStyle(fontSize: 16)),
              onPressed: () {},
            ),
            SizedBox(width: 18, height: MediaQuery.of(context).size.height / 55),
          ],
